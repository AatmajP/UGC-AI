...
import { GoogleGenAI, GenerateContentConfig,HarmBlockThreshold,HarmCategory } from '@google/genai';
...
const genrateContentConfig: GenerateContentConfig = {
...
if (!operation.response.generatedVideos) {
  throw new Error(operation.response.raiMediaFilteredReasons)
}
...
export const getAllPublishProject = async (req: Request, res: Response) => {
  try {
